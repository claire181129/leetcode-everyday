                                ...
                                else
                                {
                                    ...
                                    if(rightIndex == index+1)
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            std::cout<<"\tcompute "<<leftOperand<<std::string(1,expression[index])<<rightOperand<<"="<<result<<" substr:"<<substr<<" after comput expression"<<expression<<std::endl;
                                        }
                                    }
                                    else
                                    {
                        ...
                        if(rightIndex<size)
                        {
                            if(rightIndex == index+1)
                            {
                                ...
                                if(tempIndex>=size)
                                {
                                    ...
                                    expression.insert(leftIndex,substr);
                                    expression.erase(leftIndex+substr.size(),rightIndex-leftIndex);
                                    std::cout<<"\t"<<leftOperand<<std::string(1,expression[index])<<rightOperand<<"="<<result<<" after compute expression:"<<expression<<std::endl;
                                    result = computeExpression(expression,legal);
                                }
                            }
                            else
